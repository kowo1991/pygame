...
class Player(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        self.rect.midbottom = self.pos#vec(round(self.pos.x), round(self.pos.y))
        self.animate()
    ...
    def jump(self):
        # jump only if stand on a platform
        self.rect.x += 2
...
class Cloud(pg.sprite.Sprite):
    def __init__(self, game):
        ...
        self.rect = self.image.get_rect()
        scale = randrange(20, 70) / 100
        self.image = pg.transform.scale(self.image, (round(self.rect.width*scale), round(self.rect.height*scale)))
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
